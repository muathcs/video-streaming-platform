            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-300">
                  Find the right celeb for any occasion Birthdays, milestones,
                  or even a well-deserved roast, the perfect celebrity is only a
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-300">
                  ...
                  up to 7 days to complete it. Choose our 24hr delivery option
